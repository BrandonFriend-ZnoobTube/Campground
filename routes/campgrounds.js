...
router.get('/:id/edit', isLoggedIn, validateCampAuthor, TryAsync(async (req, res) => {
  const camp = await Campground.findById(req.params.id);
...
router.put('/:id', isLoggedIn, validateCampground, validateCampAuthor, TryAsync(async (req, res) => {
  const { id } = req.params;
...
router.delete('/delete/:id', isLoggedIn, validateCampAuthor, TryAsync(async (req, res) => {
  const { id } = req.params;
